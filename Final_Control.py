...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        self._camera_transforms = [
            (carla.Transform(carla.Location(x=1.5, z=1.4)), Attachment.Rigid),
        ]
        ...
        for item in self.sensors:
            ...
            item.append(bp)
        self.index = None
        # bp.listen(lambda image: image.save_to_disk('output/%06d.png' % image.frame))
    ...
    def _parse_image(weak_self, image):
        ...
        if self.sensors[self.index][0].startswith('sensor.lidar'):
            ...
            array = array[:, :, :3]
            if key_no:
                process_data(array, speed, angle)
            # print(angle)
            # print(speed)
            array = array[:, :, ::-1]
...
def main():
    ...
    argparser.add_argument(
        ...
        default='1280x640',
        help='window resolution (default: 1280x640)')
    argparser.add_argument(
        '--filter',
        metavar='PATTERN',
        default='vehicle.*',
